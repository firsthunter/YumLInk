...
public class FadeInRightTransition extends AnimationConfiguration
{
  /**
  ...
  {
    super(node, TimelineBuilder.create().keyFrames(
        ...
        new KeyFrame(Duration.millis(1000), new KeyValue(node.opacityProperty(), 1, WEB_EASE),
            new KeyValue(node.translateXProperty(), 0, WEB_EASE))).build());
