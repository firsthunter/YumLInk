...
public class AnimationConfiguration extends Transition
{
   ...
   */
  public AnimationConfiguration(final Node node, final Timeline timeline)
  {
   ...
   */
  public AnimationConfiguration(final Node node, final Timeline timeline, final boolean useCache)
  {
    this.node = node;
